...
Content makes the world go round. Beautiful design and an engaging layout will help them connect with your business, but they stay to read the content and find out more about you. That is why we focus on content and how people will be reading the content on the website.

What you may not know is that the web is a platform for providing content. Behind all of the attractive layouts, excellent development techniques and whizz-bang animation is the simple fact that the web is a content delivery platform. If your website looks nice and fancy but says nothing, then the paths to your business being found on the internet are going to be few and narrow.

Search Engines see differently to human eyes, they trawl thousands of websites and remember headings, tags, words, word placement and the code, which gives us a position of a search results page. The Content of the page produces a “Page Rank”, not the nice style, which is why we talk a lot about Content (note the capital "C" there).

A static website is a great brochure, but a constantly updated website increases the chance for your website being found. It shows that you are still relevant as a business and that the site is being used.

The first thing you should do once you have a website is to have other people visit it, direct existing clients to it and get links pointing to it.

The next thing is to update the content. Just like you frequently have some news to report to your friends, your website should have regular news updates as well. These updates may not be about the company directly, but can also be about the industry you are in. When adding content remember that you are building __authority__ with word association, talk about what is important to you as a business.
...
* Adds more keywords to the website - these are associated words that helps Search Engines find your site;
...
When Google began, it changed the way information was gathered. Over time the Google algorithm ignored the meta information and stored information from inside the website body. Google became so popular because it ignored the hidden information which could contain misleading information and made the search results dependant on the content of the page. People could search and read information on the topic for which they searched.

The inclusion of meta information is important for some aspects of good search rankings, but meta keywords are not included as a part of those good rankings. Now the term "Keywords" refers to the targeted words you use and reuse within your site, with which you want clients to find you.
...
The content is the important part of being found from a search. While the headers and hidden html code goes into the secret sauce, it is the content which is the King. The content is the meat between the bread, it speaks to your business proposition, your sales and marketing, it is where the most focus should go. We search using words, so it makes sense that words are the most important part of the website.
...
Search engines check your content against what has been searched on. If your content seems forced or contrived to a specific point it is considered a false positive and not ranked as high in results. If it is mainly repeated words with no sentences, it is ranked down as well.
...
A solid Web Strategy is important to a website if you want to see a return of investment, because on going content and discussion is important to building a platform of authority. Real People are writing Real Articles that are Really being Shared. Over time, you become a voice in your target industry.
...
The Message is an ongoing discussion you begin from your website. A series of discussion points that you use to build a platform of authority. The Message is a campaign, a point of focus for your advertising. One product at a time you build a series of articles or posts to show that you know and understand your business.

Regular and varied posts on the same topic will build a repository of knowledge associated with your website. Over time search engines will trust the knowledges coming from your website and recommend you by ranking you closer to the elusive number one spot on results pages.

t may take a while to see decent results after beginning a discussion on a topic, but this is normal. Remember when you are starting that you have zero keywords associated with your website and you are starting from the very bottom. Each campaign you do using The Message will add keywords to your site and help, over time, to boost rankings from those keywords.
...
Focus on a single topic at a time, and make that focus extend over a few months. Don't try and advertise everything you do all at once, the more topics you talk about to more convoluted your message is.

If you have a mailing list setup on the site, you can group a series of excerpts from the latest articles and have that sent to the subscribers. They will appreciate the email and it may bring a new round of viewers to the site, reading articles they may have missed.
...
Consider using staff you already have, hiring people to accomplish this task or use freelance writers to help write. You can always change writers over time as you understand how clients are using your website and you are seeing results, good or bad, coming from what has been published.
...
A good freelance writer will be able to fill gaps of information and research topics to keep content flowing. You may have to shop around to find someone who works well with your business. Removing the continued responsibility of updating your website for an internal resource may be the best way to ensure it is updated.

#### Internal Content Writers

As the business owner you may know of a staff member who enjoys writing, or you can undertake this task of writing for your website. Having someone in the business who can do the writing eases the selection process of finding a freelance writer. There are other benefits to having staff write for you:

* Staff understand the business from the inside;
* Staff can ask questions directly when unsure about topic;
* Staff can start internal discussions based on the topics they are writing about, which encourages more involvement in the process.
...
If you notice a particular topic is bringing in readers then keep writing about it. If a topic is engaging readers, be flexible in your schedule and write more on what they want to see. By giving readers what they want you are listening to the market, getting more viewers to your website and increasing the likeliness of having links shared.
